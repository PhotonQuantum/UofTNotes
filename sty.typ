...
#let DEFAULT_THEME = (
  accent: rgb(136, 57, 239),
  block: rgb(111, 77, 161),
  definition: rgb(0, 106, 97),
  example: rgb(130, 48, 113),
  note: rgb(0, 101, 145),
  attention: rgb(186, 26, 26),
  quote: rgb(111, 77, 161),
  theorem: rgb(0, 88, 105),
  proposition: rgb(145, 12, 87),
)
...
#let template(
  ...
  // The color theme of the lecture notes.
  theme: DEFAULT_THEME,
  ...
  let accent_color = reify_color(theme.accent)
...
#let blockquote(cite: none, body) = [
  ...
  #context {
    pad(left: 1.5em)[
      #let accent_color = reify_color(state("theme").get().block)
      #block(
        breakable: true,
        width: 100%,
        fill: accent_color.lighten(90%),
        radius: (left: 0pt, right: 5pt),
        stroke: (left: 5pt + accent_color, rest: 1pt + silver),
        inset: 1em,
      )[#body]
    ]
  }
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().definition),
          title-color: reify_color(state("theme").get().definition).lighten(30%),
          body-color: reify_color(state("theme").get().definition).lighten(95%),
          footer-color: reify_color(state("theme").get().definition).lighten(80%),
        ),
        ..args.named(),
        body,
      )
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().example),
          title-color: reify_color(state("theme").get().example).lighten(30%),
          body-color: reify_color(state("theme").get().example).lighten(95%),
          footer-color: reify_color(state("theme").get().example).lighten(80%),
        ),
        ..args.named(),
        body,
      )
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().note),
          title-color: reify_color(state("theme").get().note).lighten(30%),
          body-color: reify_color(state("theme").get().note).lighten(95%),
          footer-color: reify_color(state("theme").get().note).lighten(80%),
        ),
        ..args.named(),
        body,
      )
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().attention),
          title-color: reify_color(state("theme").get().attention).lighten(30%),
          body-color: reify_color(state("theme").get().attention).lighten(95%),
          footer-color: reify_color(state("theme").get().attention).lighten(80%),
        ),
        ..args.named(),
        body,
      )
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().quote),
          title-color: reify_color(state("theme").get().quote).lighten(30%),
          body-color: reify_color(state("theme").get().quote).lighten(95%),
          footer-color: reify_color(state("theme").get().quote).lighten(80%),
        ),
        ..args.named(),
        body,
      )
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().theorem),
          title-color: reify_color(state("theme").get().theorem).lighten(30%),
          body-color: reify_color(state("theme").get().theorem).lighten(95%),
          footer-color: reify_color(state("theme").get().theorem).lighten(80%),
        ),
        ..args.named(),
        body,
      )
  ...
  (name, number, body, ..args) => (
    context {
      showybox(
        ...
        frame: (
          border-color: reify_color(state("theme").get().proposition),
          title-color: reify_color(state("theme").get().proposition).lighten(30%),
          body-color: reify_color(state("theme").get().proposition).lighten(95%),
          footer-color: reify_color(state("theme").get().proposition).lighten(80%),
        ),
        ..args.named(),
        body,
      )
